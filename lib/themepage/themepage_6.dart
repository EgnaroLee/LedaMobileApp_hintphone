...
class _ThemeScreenState extends State<ThemeScreen6> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context){
    ...
    // 힌트 코드 사용 시 배경 색 변경
    Color hintbackcolor1 = _onHintCode1 ? Color(purple2) : Colors.white;
    Color hintbackcolor2 = _onHintCode2 ? Color(purple2) : Colors.white;
    Color hintbackcolor3 = _onHintCode3 ? Color(purple2) : Colors.white;
    Color hintbackcolor4 = _onHintCode4 ? Color(purple2) : Colors.white;
    Color hintbackcolor5 = _onHintCode5 ? Color(purple2) : Colors.white;
    Color hintbackcolor6 = _onHintCode6 ? Color(purple2) : Colors.white;
    Color hintbackcolor7 = _onHintCode7 ? Color(purple2) : Colors.white;
