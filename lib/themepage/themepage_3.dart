...
import 'package:hint_app_7/theme3_hintpage/theme3_hint1.dart';
import 'package:hint_app_7/theme3_hintpage/theme3_hint2.dart';
import 'package:hint_app_7/theme3_hintpage/theme3_hint3.dart';
import 'package:hint_app_7/theme3_hintpage/theme3_hint4.dart';
import 'package:hint_app_7/theme3_hintpage/theme3_hint5.dart';
import 'package:hint_app_7/theme3_hintpage/theme3_hint6.dart';
import 'package:hint_app_7/theme3_hintpage/theme3_hint7.dart';
import 'package:hint_app_7/theme3_hintpage/theme3_hint8.dart';
import 'package:hint_app_7/theme3_hintpage/theme3_hint9.dart';
...
class ThemeScreen3 extends StatefulWidget {
  final int PlayTime;
  ThemeScreen3({required this.PlayTime});

  @override
  State<ThemeScreen3> createState() => _ThemeScreenState();
}

class _ThemeScreenState extends State<ThemeScreen3> with SingleTickerProviderStateMixin {
  // 타이머
  late Timer _timer;
  ...
  Widget build(BuildContext context) {
    ...
    // 힌트 코드 사용 시 배경 색 변경
    Color hintbackcolor1 = _onHintCode1 ? Color(yellow2) : Colors.white;
    Color hintbackcolor2 = _onHintCode2 ? Color(yellow2) : Colors.white;
    Color hintbackcolor3 = _onHintCode3 ? Color(yellow2) : Colors.white;
    Color hintbackcolor4 = _onHintCode4 ? Color(yellow2) : Colors.white;
    Color hintbackcolor5 = _onHintCode5 ? Color(yellow2) : Colors.white;
    Color hintbackcolor6 = _onHintCode6 ? Color(yellow2) : Colors.white;
    Color hintbackcolor7 = _onHintCode7 ? Color(yellow2) : Colors.white;
    Color hintbackcolor8 = _onHintCode8 ? Color(yellow2) : Colors.white;
    Color hintbackcolor9 = _onHintCode9 ? Color(yellow2) : Colors.white;
                                                    ...
                                                    children: [
                                                      ...
                                                      Flexible(
                                                        child: Container(
                                                          ...
                                                          decoration: BoxDecoration(color: Color(yellow1), borderRadius: BorderRadius.circular(20)),
                                                          child: InkWell(
                                                            onTap: () async {
                                                              ...
                                                              if (_hintText.text == _hintcode1) {
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn1 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme3HintPage1()));
                                                                });
                                                              }
                                                              ...
                                                              // 힌트 2번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn2 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme3HintPage2()));
                                                                });
                                                              }
                                                              ...
                                                              // 힌트 3번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn3 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme3HintPage3()));
                                                                });
                                                              }
                                                              ...
                                                              // 4번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn4 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme3HintPage4()));
                                                                });
                                                              }
                                                              ...
                                                              // 5번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn5 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme3HintPage5()));
                                                                });
                                                              }
                                                              ...
                                                              // 6번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn6 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme3HintPage6()));
                                                                });
                                                              }
                                                              ...
                                                              // 7번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn7 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme3HintPage7()));
                                                                });
                                                              }
                                                              ...
                                                              // 8번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn8 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme3HintPage8()));
                                                                });
                                                              }
                                                              ...
                                                              // 9번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn9 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme3HintPage9()));
                                                                });
                                                                          ...
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme3HintPage1()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(yellow2),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn2
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme3HintPage2()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(yellow2),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn3
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme3HintPage3()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(yellow2),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn4
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme3HintPage4()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(yellow2),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn5
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme3HintPage5()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(yellow2),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn6
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme3HintPage6()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(yellow2),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn7
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme3HintPage7()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(yellow2),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn8
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme3HintPage8()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(yellow2),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn9
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme3HintPage9()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(yellow2),
