...
import 'package:hint_app_7/theme5_hintpage/theme5_hint1.dart';
import 'package:hint_app_7/theme5_hintpage/theme5_hint2.dart';
import 'package:hint_app_7/theme5_hintpage/theme5_hint3.dart';
import 'package:hint_app_7/theme5_hintpage/theme5_hint4.dart';
import 'package:hint_app_7/theme5_hintpage/theme5_hint5.dart';
import 'package:hint_app_7/theme5_hintpage/theme5_hint6.dart';
import 'package:hint_app_7/theme5_hintpage/theme5_hint7.dart';
import 'package:hint_app_7/theme5_hintpage/theme5_hint8.dart';
import 'package:hint_app_7/theme5_hintpage/theme5_hint9.dart';
...
class ThemeScreen5 extends StatefulWidget {
  final int PlayTime;
  ThemeScreen5({required this.PlayTime});

  @override
  State<ThemeScreen5> createState() => _ThemeScreenState();
}

class _ThemeScreenState extends State<ThemeScreen5> with SingleTickerProviderStateMixin {
  // 타이머
  late Timer _timer;
                                                            ...
                                                            onTap: () async {
                                                              ...
                                                              if (_hintText.text == _hintcode1) {
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn1 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme5HintPage1()));
                                                                });
                                                              }
                                                              ...
                                                              // 힌트 2번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn2 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme5HintPage2()));
                                                                });
                                                              }
                                                              ...
                                                              // 힌트 3번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn3 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme5HintPage3()));
                                                                });
                                                              }
                                                              ...
                                                              // 4번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn4 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme5HintPage4()));
                                                                });
                                                              }
                                                              ...
                                                              // 5번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn5 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme5HintPage5()));
                                                                });
                                                              }
                                                              ...
                                                              // 6번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn6 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme5HintPage6()));
                                                                });
                                                              }
                                                              ...
                                                              // 7번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn7 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme5HintPage7()));
                                                                });
                                                              }
                                                              ...
                                                              // 8번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn8 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme5HintPage8()));
                                                                });
                                                              }
                                                              ...
                                                              // 9번 코드
                                                                ...
                                                                setState(() {
                                                                  _hintText.text = '';
                                                                  _ShowHintBtn9 = true;
                                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Theme5HintPage9()));
                                                                });
                                                                          ...
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme5HintPage1()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(skyblue),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn2
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme5HintPage2()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(skyblue),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn3
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme5HintPage3()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(skyblue),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn4
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme5HintPage4()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(skyblue),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn5
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme5HintPage5()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(skyblue),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn6
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme5HintPage6()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(skyblue),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn7
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme5HintPage7()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(skyblue),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn8
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme5HintPage8()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(skyblue),
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: _ShowHintBtn9
                                                                          ? InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context,
                                                                                    MaterialPageRoute(builder: (context) => Theme5HintPage9()));
                                                                              },
                                                                              child: Expanded(
                                                                                  child: Container(
                                                                                      color: Color(skyblue),
