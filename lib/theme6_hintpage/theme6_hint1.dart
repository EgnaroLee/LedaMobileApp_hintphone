...
class Theme6HintPage1 extends StatefulWidget {
  const Theme6HintPage1({super.key});

  @override
  State<Theme6HintPage1> createState() => _HintPageState();
}

class _HintPageState extends State<Theme6HintPage1> {
  @override
  void initState() {
    super.initState();
  }
