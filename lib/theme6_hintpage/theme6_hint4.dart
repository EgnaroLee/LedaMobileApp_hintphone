...
class Theme6HintPage4 extends StatefulWidget {
  const Theme6HintPage4({super.key});

  @override
  State<Theme6HintPage4> createState() => _HintPageState();
}

class _HintPageState extends State<Theme6HintPage4> {
  @override
  void initState() {
    super.initState();
  }
