...
class Theme6HintPage2 extends StatefulWidget {
  const Theme6HintPage2({super.key});

  @override
  State<Theme6HintPage2> createState() => _HintPageState();
}

class _HintPageState extends State<Theme6HintPage2> {
  @override
  void initState() {
    super.initState();
  }
