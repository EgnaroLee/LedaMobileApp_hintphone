...
class Theme6HintPage6 extends StatefulWidget {
  const Theme6HintPage6({super.key});

  @override
  State<Theme6HintPage6> createState() => _HintPageState();
}

class _HintPageState extends State<Theme6HintPage6> {
  @override
  void initState() {
    super.initState();
  }
