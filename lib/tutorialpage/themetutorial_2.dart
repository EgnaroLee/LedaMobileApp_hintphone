...
import 'package:hint_app_7/themepage/themepage_2.dart';

final skyblue = 0x99add8e6;


class ThemeTuto2 extends StatefulWidget{

  final int PlayTime;
  ThemeTuto2({required this.PlayTime});

  @override
  State<ThemeTuto2> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<ThemeTuto2>{
                ...
                Container(
                    child: Center(
                      child: Container(
                          ...
                          width: 140,
                          decoration: BoxDecoration(
                              color: Color(orange2),  // 상자 크기
                              borderRadius: BorderRadius.circular(20) // 모서리 둥굴게
                          ),
                          child: InkWell(
                            onTap: (){
                              Navigator.push(context,
                                  MaterialPageRoute(builder: (context)=> ThemeScreen2(PlayTime: widget.PlayTime)
                                  )
                              );
                            },
                            child: Center(
