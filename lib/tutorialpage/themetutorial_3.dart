...
import 'package:hint_app_7/themepage/themepage_3.dart';

final skyblue = 0x99add8e6;


class ThemeTuto3 extends StatefulWidget{

  final int PlayTime;
  ThemeTuto3({required this.PlayTime});

  @override
  State<ThemeTuto3> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<ThemeTuto3>{
                ...
                Container(
                    child: Center(
                      child: Container(
                          ...
                          width: 140,
                          decoration: BoxDecoration(
                              color: Color(yellow2),  // 상자 크기
                              borderRadius: BorderRadius.circular(20) // 모서리 둥굴게
                          ),
                          child: InkWell(
                            onTap: (){
                              Navigator.push(context,
                                  MaterialPageRoute(builder: (context)=> ThemeScreen3(PlayTime: widget.PlayTime)
                                  )
                              );
                            },
                            child: Center(
