...
class ThemeTuto1 extends StatefulWidget {
  final int PlayTime;
  ThemeTuto1({required this.PlayTime});

  @override
  State<ThemeTuto1> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<ThemeTuto1> {
                  ...
                  child: Container(
                    child: Center(
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => ThemeScreen1(PlayTime: widget.PlayTime)));
                          },
                          child: Center(
                            child: Container(
                              child: AutoSizeText(
