...
class Theme4HintPage2 extends StatefulWidget {
  const Theme4HintPage2({super.key});

  @override
  State<Theme4HintPage2> createState() => _HintPageState();
}

class _HintPageState extends State<Theme4HintPage2> {
  @override
  void initState() {
    super.initState();
  }
