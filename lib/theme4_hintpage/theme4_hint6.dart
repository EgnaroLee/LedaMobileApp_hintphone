...
class Theme4HintPage6 extends StatefulWidget {
  const Theme4HintPage6({super.key});

  @override
  State<Theme4HintPage6> createState() => _HintPageState();
}

class _HintPageState extends State<Theme4HintPage6> {
  @override
  void initState() {
    super.initState();
  }
