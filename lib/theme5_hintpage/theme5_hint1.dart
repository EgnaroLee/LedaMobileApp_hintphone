...
class Theme5HintPage1 extends StatefulWidget {
  const Theme5HintPage1({super.key});

  @override
  State<Theme5HintPage1> createState() => _HintPageState();
}

class _HintPageState extends State<Theme5HintPage1> {
  @override
  void initState() {
    super.initState();
  }
