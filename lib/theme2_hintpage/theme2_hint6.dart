...
class Theme2HintPage6 extends StatefulWidget {
  const Theme2HintPage6({super.key});

  @override
  State<Theme2HintPage6> createState() => _HintPageState();
}

class _HintPageState extends State<Theme2HintPage6> {
  @override
  void initState() {
    super.initState();
  }
