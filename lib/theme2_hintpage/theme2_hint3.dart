...
class Theme2HintPage3 extends StatefulWidget {
  const Theme2HintPage3({super.key});

  @override
  State<Theme2HintPage3> createState() => _HintPageState();
}

class _HintPageState extends State<Theme2HintPage3> {
  @override
  void initState() {
    super.initState();
  }
