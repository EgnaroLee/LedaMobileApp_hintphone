...
class Theme2HintPage1 extends StatefulWidget {
  const Theme2HintPage1({super.key});

  @override
  State<Theme2HintPage1> createState() => _HintPageState();
}

class _HintPageState extends State<Theme2HintPage1> {
  @override
  void initState() {
    super.initState();
  }
