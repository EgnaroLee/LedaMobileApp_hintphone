...
class Theme2HintPage2 extends StatefulWidget {
  const Theme2HintPage2({super.key});

  @override
  State<Theme2HintPage2> createState() => _HintPageState();
}

class _HintPageState extends State<Theme2HintPage2> {
  @override
  void initState() {
    super.initState();
  }
