...
class _StartPageState extends State<StartPage> with SingleTickerProviderStateMixin {
  ...
  final List<String> _tablabels = ['1번 테마', '2번테마', '3번 테마', '4번 테마', '5번 테마', '6번 테마'];
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Flexible(
                                          child: Container(
                                            margin: EdgeInsets.only(top: 5, bottom: 10, left: 10, right: 5),
                                            child: Row(
                                              children: [
                                                Flexible(
                                                    child: Container(
                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  child: Container(
                                                    margin: EdgeInsets.only(top: 10, bottom: 5),
                                                    decoration:
                                                    BoxDecoration(color: Color(darkblue), borderRadius: BorderRadius.circular(15)),
                                                    child: InkWell(
                                                      onTap: () {
                                                        _delall1();
                                                      },
